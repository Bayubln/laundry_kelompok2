							...
							<div class="x_panel">
								...
								<div class="x_content">
                                    ...
                                    ?>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="nama">Nama Pengguna<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="username" class="form-control" type="text" name="username" value="<?= $o->username ?>">
											</div>
										</div>
                                        <div class="item form-group">
											<label for="id_outlet" class="col-form-label col-md-3 col-sm-3 label-align">Id Outlet</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="id_outlet" class="form-control" type="text" name="id_outlet" value="<?= $o->id_outlet ?>">
											</div>
										</div>
                                        <div class="item form-group">
											<label for="role" class="col-form-label col-md-3 col-sm-3 label-align">Role</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="role" class="form-control" type="text" name="role" value="<?= $o->role ?>">
											</div>
										</div>
                                        <div class="item form-group">
											<label for="aksi" class="col-form-label col-md-3 col-sm-3 label-align">Aksi</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="aksi" class="form-control" type="text" name="aksi" value="<?= $o->aksi ?>">
											</div>
										</div>
